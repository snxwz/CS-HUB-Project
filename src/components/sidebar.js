        ...
        {isLoggedIn ? (
          <>
            <div className='bg-dark col-2 col-md-2 min-vh-100 d-flex justify-content-betweet flex-column'>
              <div>
                {/* <a className='text-decoration-none text-white d-none d-md-inline d-flex align-itemcenter ms-3 mt-2' href='/'>
                ...
                <ul className='nav nav-pills flex-column'>
                  ...
                  <li className='nav-item text-white fs-4 my-1 py-2 py-sm-0'>
                    <a href={`/profile?profile=${session.U_id}`} className='nav-link text-white fs-5' aria-current="page">
                      ...
                      <span className='ms-3 d-none d-md-inline'>Videos</span>
                    </a>
                  </li>
                  ...
                  <li className='nav-item text-white fs-4 my-1 py-2 py-sm-0'>
                    <a href='/history' className='nav-link text-white fs-5' aria-current="page">
                      ...
                      <span className='ms-3 d-none d-md-inline'>History</span>
                    </a>
                  </li>
                  ...
                  {session.U_permit === 1 && (
                    <li className='nav-item text-white fs-4 my-1 py-2 py-sm-0'>
                      <a href='/upload' className='nav-link text-white fs-5' aria-current="page">
                        ...
                        <span className='ms-3 d-none d-md-inline'>Upload Video</span>
                      </a>
                    </li>
                  )}
                  ...
                  {session.U_type === 'admin' && (
                    <li className='nav-item text-white fs-4 my-1 py-2 py-sm-0'>
                      <a href='/admin' className='nav-link text-white fs-5' aria-current="page">
                        ...
                        <span className='ms-3 d-none d-md-inline'>Administration</span>
                      </a>
                    </li>
                  )}
              ...
              <div class="dropdown open">
                <a class="text-decoration-none text-white dropdown-toggle p-3" type="button" id="triggerId" data-bs-toggle="dropdown" aria-haspopup="true"
                  aria-expanded="false">
                  <i class="bi bi-person-circle"></i><span className='ms-2 d-none d-md-inline'>CS ADMIN</span>
                </a>
          ...
          <div className='bg-dark col-2 col-md-2 min-vh-100 d-flex justify-content-betweet flex-column'>
            <div>
              <a className='text-decoration-none text-white d-none d-md-inline d-flex align-itemcenter ms-3 mt-2' href='/'>
                <span className='ml-1 fs-4 d-none d-md-inline'>CS HUB</span>
              </a>
              <hr className='text-secondary d-none d-md-block' />
              <ul className='nav nav-pills flex-column'>
                <li className='nav-item text-white fs-4 my-1 py-2 py-sm-0'>
